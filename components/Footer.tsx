        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-6">
              ...
              <a href="mailto:business.brandlyon@gmail.com" className="hover:text-purple-400 transition-colors">
                business.brandlyon@gmail.com
              </a>
            </p>
            <div className="flex gap-4">
              {[
                { icon: <Instagram />, url: "https://www.instagram.com/brandlyon_offl", label: "Brandlyon Official" },
                { icon: <Instagram />, url: "https://www.instagram.com/doeshi_influencer_offl", label: "Reach Us Here" },
                { icon: <Linkedin />, url: "https://www.linkedin.com/in/brandlyon-marketing-agency-3a8b693a2/", label: "LinkedIn" }
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.url}

...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="relative min-h-[100dvh] flex flex-col items-center justify-center pt-24 pb-12 md:pt-32 md:pb-20 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 text-center flex flex-col items-center w-full">

        <Reveal>
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-[11px] sm:text-xs font-medium text-purple-300 mb-6 md:mb-8 backdrop-blur-sm">
        ...
        <Reveal delay={100}>
          <h1 className="text-[2rem] leading-[1.2] sm:text-5xl md:text-7xl font-bold tracking-tight mb-5 md:mb-6 px-2 sm:px-0">
        ...
        <Reveal delay={200}>
          <p className="text-[0.95rem] sm:text-lg md:text-xl text-gray-400 max-w-2xl mb-8 md:mb-10 leading-relaxed px-2 sm:px-4">
        ...
        <div className="mt-16 sm:mt-20 w-full">
          <Reveal delay={400} width="100%">
            <div className="mb-6 sm:mb-8">
              <span className="block font-medium text-[0.65rem] sm:text-xs md:text-sm uppercase tracking-[0.2em] text-gray-500 mb-2">
                Already used by
              </span>
